...
public class ResourceCentreTest {
	...
	public void testDoLoanChromebook() {
		...
		// normal
		Boolean ok = ResourceCentre.doLoanChromebook(chromebookList, "CB0011", "15-07-2022" );
		assertTrue("Test if an available item is ok to loan?", ok);
		assertFalse(chromebookList.get(0).getIsAvailable());
		assertEquals(chromebookList.get(0).getDueDate(),"15-07-2022");
		
				
		//error condition
		ok = ResourceCentre.doLoanChromebook(chromebookList, "CB0011", "15-07-2022" );
		assertFalse("Test if an same item is NOT ok to loan again?", ok);	
		
		//error condition
		ResourceCentre.addChromebook(chromebookList, cb2);	
		cb2.setIsAvailable(false);
		ok = ResourceCentre.doLoanChromebook(chromebookList, "CB0012", "15-07-2022" );
		assertFalse("Test that un-available item is NOT ok to loan?", ok);
